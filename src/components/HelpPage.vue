      ...
      <div class="mb-8 flex items-center justify-between">
        <div>
          ...
          <p class="text-muted-foreground text-lg">
            Learn how to use the VDA5050 Visualizer to monitor and visualize your AGV fleet
          </p>
        </div>
        <Button variant="outline" @click="emit('close')" class="flex items-center gap-2">
          ...
          <CardContent class="space-y-4">
            <div>
              ...
              <ol class="list-decimal list-inside space-y-2 ml-4">
                <li>Click the <strong>"Connect"</strong> button in the top menu bar</li>
                <li>Fill in your MQTT broker details:
                ...
                <li>Select connection type:
                  <ul class="list-disc list-inside ml-6 mt-1 space-y-1">
                    <li><strong>WebSocket:</strong> For web browser connections</li>
                    <li><strong>MQTT (Electron only):</strong> For desktop application connections</li>
                  </ul>
                </li>
            ...
            <div>
              ...
              <p class="mb-2">
                Modern web browsers cannot access the MQTT protocol directly. You need to enable WebSocket support in your MQTT broker.
              </p>
              <p class="mb-2">For Mosquitto, add the following to <code class="bg-muted px-1 rounded">/etc/mosquitto/mosquitto.conf</code>:</p>
              <pre class="bg-muted p-4 rounded-md overflow-x-auto text-sm"><code>per_listener_settings true
listener 1883
...
allow_anonymous true</code></pre>
            ...
            <div>
              ...
              <p>
                Once connected, AGVs will automatically appear in the left sidebar as they connect to the MQTT broker.
                The network graph in the center will display all AGVs and their paths in real-time.
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <div>
              ...
              <div class="space-y-3">
                <div class="flex items-start gap-3">
                  <Icon icon="ph:sidebar-simple" class="h-5 w-5 mt-0.5 text-primary" />
                  <div>
                    <strong>Left Sidebar (AGV List)</strong>
                    <p class="text-sm text-muted-foreground">
                      Displays all connected AGVs as cards. Click on any AGV card to select it and view detailed information.
                    </p>
                  </div>
                </div>
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                      Interactive visualization showing AGV positions, paths, nodes, and edges. You can zoom, pan, and interact with the graph.
                    </p>
                  </div>
                </div>
                <div class="flex items-start gap-3">
                  <Icon icon="ph:sidebar-simple" class="h-5 w-5 mt-0.5 text-primary rotate-y-180" />
                  <div>
                    <strong>Right Sidebar (AGV Details)</strong>
                    <p class="text-sm text-muted-foreground">
                      Shows detailed information about the selected AGV, including raw JSON data, order information, and instant actions.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div class="space-y-2">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-sm">Opens the MQTT connection settings dialog</span>
                </div>
                <div class="flex items-center gap-2">
                  <Badge variant="outline">View</Badge>
                  <span class="text-sm">Access view settings (e.g., Show Grid toggle)</span>
                </div>
                <div class="flex items-center gap-2">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-sm">Toggle left/right sidebars visibility</span>
                </div>
                <div class="flex items-center gap-2">
                  <Icon icon="ph:layout" class="h-4 w-4" />
                  <span class="text-sm">Switch between Dashboard and Visualizer views</span>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent class="space-y-4">
            <div>
              ...
              <ul class="list-disc list-inside space-y-1 ml-4">
                <li><strong>AGV Identifier:</strong> Manufacturer and Serial Number (e.g., <code class="bg-muted px-1 rounded">Manufacturer / SerialNumber</code>)</li>
                <li><strong>Connection Status Badge:</strong>
            ...
            <div>
              ...
              <div class="space-y-2">
                <div class="flex items-center gap-2">
                  ...
                  <span><strong>Position:</strong> Current x, y coordinates and orientation (θ)</span>
                </div>
                <div class="flex items-center gap-2">
                  <Icon icon="material-symbols:speed" class="h-4 w-4" />
                  <span><strong>Velocity:</strong> Linear velocity (vx, vy) components</span>
                </div>
                <div class="flex items-center gap-2">
                  <Icon icon="material-symbols:auto-mode" class="h-4 w-4" />
                  <span><strong>Operating Mode:</strong> Current AGV operating mode</span>
                </div>
                <div class="flex items-center gap-2">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <span><strong>Actions:</strong> Number of pending actions</span>
                </div>
                <div class="flex items-center gap-2">
                  <Icon icon="material-symbols:error" class="h-4 w-4 text-red-500" />
                  <span><strong>Errors:</strong> Error count (fatal errors shown in red, warnings in yellow)</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="space-y-2">
                <div>
                  ...
                  <p class="text-sm text-muted-foreground">
                    Click to expand and view order details including Order ID, Update ID, Header ID, and timestamp.
                  </p>
                </div>
                <div>
                  <strong>Instant Actions</strong>
                  <p class="text-sm text-muted-foreground">
                    Click to expand and view instant action information including Action ID and count.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p class="text-sm text-muted-foreground">
                Shows the completion progress of the current order sequence (current node / total nodes) as a percentage.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent class="space-y-4">
            <div>
              ...
              <ul class="list-disc list-inside space-y-2 ml-4">
                <li><strong>Nodes:</strong> Represent waypoints or positions in the AGV's path</li>
                <li><strong>Edges:</strong> Represent paths between nodes</li>
                <li><strong>AGV Icons:</strong> Show current positions of all AGVs</li>
                <li><strong>Colors:</strong> Different colors indicate different states or action types</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul class="list-disc list-inside space-y-2 ml-4">
                ...
                <li><strong>Select AGV:</strong> Click on an AGV icon or card to select it and view details</li>
                <li><strong>Hover:</strong> Hover over nodes and edges to see additional information</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p class="text-sm text-muted-foreground">
                The graph updates in real-time as AGVs move and receive new orders. Positions, paths, and states are automatically synchronized with MQTT messages.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent class="space-y-4">
            <div>
              ...
              <ul class="list-disc list-inside space-y-1 ml-4">
                ...
                <li>Choose from Light, Dark, or System (follows OS preference)</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul class="list-disc list-inside space-y-1 ml-4">
                <li>Click the sidebar icons in the top bar to toggle visibility</li>
                <li>Resize sidebars by dragging the divider between panels</li>
                <li>Right sidebar automatically opens when an AGV is selected</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul class="list-disc list-inside space-y-1 ml-4">
                <li><strong>Dashboard:</strong> Main view with network graph and sidebars</li>
                <li><strong>Visualizer:</strong> Alternative visualization view</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p class="mb-2">When an AGV is selected, the right sidebar shows:</p>
              <ul class="list-disc list-inside space-y-1 ml-4">
        ...
        <Card>
          ...
          <CardContent class="space-y-4">
            <div>
              ...
              <div class="space-y-3">
                <div>
                  ...
                  <ul class="list-disc list-inside space-y-1 ml-4 mt-1 text-sm text-muted-foreground">
                    ...
                    <li>Verify username/password if authentication is required</li>
                  </ul>
                </div>
                <div>
            ...
            <div>
              ...
              <ul class="list-disc list-inside space-y-1 ml-4">
                <li>Verify the AGV is publishing messages to the correct MQTT topics</li>
                <li>Check that the Interface Name matches your configuration</li>
            ...
            <div>
              ...
              <ul class="list-disc list-inside space-y-1 ml-4">
                <li>Verify MQTT connection is active (check connection status)</li>
            ...
            <div>
              ...
              <ul class="list-disc list-inside space-y-1 ml-4">
                <li>Check the <a href="https://github.com/bekirbostanci/vda5050_visualizer" target="_blank" class="text-primary hover:underline">GitHub repository</a> for documentation and issues</li>
                <li>Review browser console for error messages</li>
                <li>Verify your MQTT broker configuration</li>
                <li>Ensure you're using a compatible browser (Chrome, Firefox, Edge, Safari)</li>
              </ul>
            </div>
          </CardContent>
        </Card>
      ...
      <div class="text-center text-muted-foreground text-sm mb-8">
        ...
        <p class="mt-2">
          <a href="https://github.com/bekirbostanci/vda5050_visualizer" target="_blank" class="text-primary hover:underline">
            View on GitHub
          </a>
        </p>
      </div>
